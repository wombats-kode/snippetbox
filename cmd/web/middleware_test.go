...
import (
	...
	"snippetbox.example.com/internal/assert"
)

func TestCommonHeaders(t *testing.T) {
	// Initialise a new http.ResponseRecorder and dummy http.Request.
	...
	// middleware, which writes a 200 status code and on OK response.
